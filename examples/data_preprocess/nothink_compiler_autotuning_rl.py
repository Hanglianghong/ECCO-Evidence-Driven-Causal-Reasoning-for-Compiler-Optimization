...
def construct_unified_prompt(autophase_features: Dict) -> str:
    ...
    question_parts = [
        ...
        "The program is represented by its static Autophase features.\n\n",
        ...
        "```\n\n",
        "**your final answer (the pass sequence list) must be enclosed in `<answer>``</answer>`tags.**\n",
...
def main():
    ...
    parser.add_argument('--val_llvmir_dir', default='examples/data_preprocess/llvmir_datasets/test',
                        help='存放验证集 .ll 文件的根目录。')
    parser.add_argument('--output_dir', default='examples/data_preprocess/nothink_dataset/rl',
